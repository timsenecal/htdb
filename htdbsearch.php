...
$rows = pg_num_rows($result);
print "<!-- rows = '$rows' -->\n";
print "<p><font size=\"4px\" face=\"sans-serif\" color=\"black\"><b>TV Shows found containing '$search_term':</b></font></p>\n";
print "<hr>\n";
if ($rows > 0) {
	print "<table width=100%>\n";
	print "<tr>";
