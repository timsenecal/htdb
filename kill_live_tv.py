...
query = "select station, filename, htmlfilename, id from tv_live where id = '"+id+"';"
if id == "0":
	query = "select station, filename, htmlfilename, id from tv_live where state = 'active';"
...
for record in result_list:
	...
	htmlfilename = str(record['htmlfilename'])
...
if len(pids) > 0:
	...
	del_cmd = "/bin/rm -rf "+htmlfilename
	print del_cmd
	os.system(del_cmd)
